 ...
 */
Timber::$dirname = ['./views', './views/pages', './views/includes', './views/layouts'];
...
class StarterSite extends Timber\Site
{
  ...
  {
    // $context['current_language_code'] = $my_current_lang = apply_filters(
    ...
    // $context['og_title'] = YoastSEO()->meta->for_current_page()->open_graph_title;
    // $context['og_description'] = YoastSEO()->meta->for_current_page()->open_graph_description;
    // $context['twitter_title'] = YoastSEO()->meta->for_current_page()->twitter_title;
    // $context['breadcrumbs'] = YoastSEO()->meta->for_current_page()->breadcrumbs;
